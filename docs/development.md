...
- Dev builds default to `0.4.3-SNAPSHOT`.
- Release builds use the pushed tag name (for example `v0.4.3` becomes version `0.4.3`).
...
```bash
DWARVENPICK_VERSION=0.4.3 ./gradlew :backend:app:bootJar
```
