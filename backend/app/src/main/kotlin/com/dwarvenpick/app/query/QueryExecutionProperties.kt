...
data class QueryExecutionProperties(
    ...
    val maxActiveExecutions: Int = 100,
    val maxActivePerDatasource: Int = 20,
    val maxRunningPerInstance: Int = 20,
    val maxRunningPerDatasource: Int = 5,
    val queueTimeoutSeconds: Long = 30,
