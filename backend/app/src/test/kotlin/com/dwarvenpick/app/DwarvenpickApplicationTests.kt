...
@SpringBootTest(
    properties = [
        ...
        "dwarvenpick.seed.postgres.host=localhost",
        "dwarvenpick.seed.postgres.port=15432",
        "dwarvenpick.seed.postgres.database=dwarvenpick",
        "dwarvenpick.seed.postgres.username=dwarvenpick",
        "dwarvenpick.seed.postgres.password=dwarvenpick",
        "dwarvenpick.auth.ldap.mock.users[0].username=ldap.user",
        "dwarvenpick.auth.ldap.mock.users[0].password=LdapUser123!",
        "dwarvenpick.auth.ldap.mock.users[0].display-name=LDAP User",
...
class DwarvenpickApplicationTests {
    @Autowired
