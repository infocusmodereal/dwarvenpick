...
- Dev builds default to `0.6.2-SNAPSHOT`.
- Release builds use the pushed tag name (for example `v0.6.2` becomes version `0.6.2`).
...
```bash
DWARVENPICK_VERSION=0.6.2 ./gradlew :backend:app:bootJar
```
