...
- Dev builds default to `0.4.0-SNAPSHOT`.
- Release builds use the pushed tag name (for example `v0.4.0` becomes version `0.4.0`).
...
```bash
DWARVENPICK_VERSION=0.4.0 ./gradlew :backend:app:bootJar
```
