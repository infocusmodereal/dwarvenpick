...
- Dev builds default to `0.4.1-SNAPSHOT`.
- Release builds use the pushed tag name (for example `v0.4.1` becomes version `0.4.1`).
...
```bash
DWARVENPICK_VERSION=0.4.1 ./gradlew :backend:app:bootJar
```
