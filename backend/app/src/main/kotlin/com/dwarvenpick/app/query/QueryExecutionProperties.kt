...
data class QueryExecutionProperties(
    ...
    val maxConcurrencyPerDatasource: Int = 10,
    val maxConcurrencyGlobal: Int = 30,
    val admissionRetryAttempts: Int = 20,
    val admissionRetryBackoffMs: Long = 10,
    ...
    val remoteControlPollIntervalMs: Long = 1_000,
    val lifecycleMetricsRefreshIntervalMs: Long = 10_000,
